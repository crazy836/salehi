@echo off
REM Deployment script for InfinityFree
...
REM Generate application key (run this locally before deployment)
echo Generating application key...
php artisan key:generate

REM Run migrations (optional - can be done manually through phpMyAdmin)
